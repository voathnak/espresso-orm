...
setup(
    name='espresso',  # How you named your package folder (MyLib)
    packages=['espresso'],  # Chose the same as "name"
    ...
    download_url='https://github.com/voathnak/espresso-orm/archive/v_01.tar.gz',  # I explain this later on
